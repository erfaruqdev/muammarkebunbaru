                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <div class="btn-group">
                                        ...
                                        <button onclick="addUserMenu(<?= $data->id ?>, 'LOMBA')" type="button" class="btn btn-default btn-sm" title="Beri Akses Sie. Lomba">
                                            <i class="fas fa-house-user"></i>
                                        </button>
                                        <button onclick="addUserMenu(<?= $data->id ?>, 'RESEPSIONIS')" type="button" class="btn btn-default btn-sm" title="Beri Akses Resepsionis">
                                            <i class="fas fa-user-tag"></i>
                                        </button>
                                        <button onclick="addUserMenu(<?= $data->id ?>, 'MMU')" type="button" class="btn btn-default btn-sm" title="Beri Akses MMU">
