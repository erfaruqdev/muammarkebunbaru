                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <table class="table table-head-fixed table-hover">
                                ...
                                <tbody>
                                <form action="<?= base_url() ?>valuation/save" autocomplete="off" id="form-add" method="post">
                            ...
                            <div class="row justify-content-end">
                                <div class="col-12 col-md-6 col-lg-3 col-xl-3">
                                    <button class="btn btn-primary btn-block" onclick="add()">
                                        <i class="fas fa-sync-alt"></i> Simpan Nilai
                                    </button>
                                </div>
                            </div>
                        </div>
...
<?php $this->load->view('valuation/create/js-valuation-create'); ?>