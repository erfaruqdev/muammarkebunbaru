...
<div class="content-wrapper">
    ...
    <section class="content p-3">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-5 col-xl-5 mb-2">
            </div>
            <div class="col-sm-12 col-md-6 col-lg-2 col-xl-2 mb-2">
                <form target="_blank" action="<?= base_url() ?>result/printResult" id="form-print" method="post">
                    <input type="hidden" name="contest" id="contest" value="">
                    <input type="hidden" name="category" id="category" value="">
                    <button type="button" class="btn btn-primary btn-sm w-100" onclick="submitPrint()">
...
<?php $this->load->view('result/js-result'); ?>