                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-3 col-xl-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name[12]" class="form-control mb-3 text-uppercase" tabindex="9">
                                <input type="text" name="name[13]" class="form-control text-uppercase" tabindex="10">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-3 col-xl-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name[14]" class="form-control mb-3 text-uppercase" tabindex="12">
                                <input type="text" name="name[15]" class="form-control text-uppercase" tabindex="13">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-3 col-xl-6">
                            <div class="form-group">
                                <label for="name">Lomba Olimpiade Nahwu</label>
                                <input type="text" name="name[9]" class="form-control mb-3 text-uppercase" tabindex="14">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-3 col-xl-6">
                            <div class="form-group">
                                <label for="name">Lomba Olimpiade Tajwid</label>
                                <input type="text" name="name[10]" class="form-control mb-3 text-uppercase" tabindex="15">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-3 col-xl-6">
                            <div class="form-group">
                                <label for="name">Lomba Tahsin Bil Hifdzi</label>
                                <input type="text" name="name[11]" class="form-control mb-3 text-uppercase" tabindex="16">
                            </div>
                        </div>
                    </div>
                </form>
